...
public class JanelaCompras extends javax.swing.JFrame {
    ...
    private void jButtonGravarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButtonGravarMouseClicked
        ...
        String idadeStr = jTextFieldIdade.getText().trim(); // Remove any leading/trailing white spaces
        String email = jTextFieldEmail.getText();

        if (!idadeStr.isEmpty()) {
            try {
                double idade = Double.valueOf(idadeStr);
                controle.setCompra(nome, idade, email);
                controle.gravarCompra();
            } catch (NumberFormatException e) {
                JOptionPane.showMessageDialog(this, "Por favor, insira um número válido para idade.", "Erro de Formato", JOptionPane.ERROR_MESSAGE);
            }
        } else {
            JOptionPane.showMessageDialog(this, "O campo idade não pode estar vazio.", "Campo Vazio", JOptionPane.ERROR_MESSAGE);
        }
